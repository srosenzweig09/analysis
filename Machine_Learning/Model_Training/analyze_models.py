...
fig.suptitle(rf"Test predictions vs. $m_{{bb}}$ for model {i} with {args.nlayers} hidden layers and tag {args.tag}")
...
axs[0].set_title("True Higgs Pairs")
axs[1].set_title("True Non-Higgs Pairs")
