...
np.savez('Gen_Inputs/nn_input_MX700_MY400_class_smeared.npz', x=x, y=y, mjj=mjj, extra_bkgd_x=extra_bkgd_x, extra_bkgd_y=extra_bkgd_y, extra_bkgd_mjj=extra_bkgd_mjj, params=params)