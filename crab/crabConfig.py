...
config.JobType.pluginName                       = 'Analysis' # Mandatory
...
config.JobType.inputFiles                       = ['crab/scriptExe.sh, scripts/train_nn.py, signal/skimmed/NMSSM_XYH_YToHH_6b_MX_700_MY_400_training_set_skimmed.root']
